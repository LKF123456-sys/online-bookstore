...
public class OrderApiController {  // 订单API控制器类
    ...
    public Result<OrderVO> createOrder(@RequestHeader(value = "X-User-Id", required = false) String userId, @Valid @RequestBody OrderCreateDTO dto) {  // 从请求属性获取userId，从请求体获取订单数据
    ...
    public Result<OrderVO> getOrderById(@RequestHeader(value = "X-User-Id", required = false) String userId, @PathVariable String id) {  // @PathVariable从URL中提取路径变量id
    ...
    public Result<PageResult<OrderVO>> getOrderList(  // 返回分页的订单列表
            @RequestHeader(value = "X-User-Id", required = false) String userId,  // 从请求属性获取当前用户ID
    ...
    public Result<Void> cancelOrder(@RequestHeader(value = "X-User-Id", required = false) String userId, @PathVariable String id) {  // 获取用户ID和订单ID
    ...
    public Result<Void> confirmReceive(@RequestHeader(value = "X-User-Id", required = false) String userId, @PathVariable String id) {  // 获取用户ID和订单ID
